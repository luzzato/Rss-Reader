...
public class InAppBillingPlugin extends CordovaPlugin {
	...
	private void init(final List<String> skus){
		...
		String base64EncodedPublicKeyTruncated = base64EncodedPublicKey;
		if (base64EncodedPublicKeyTruncated != null && base64EncodedPublicKeyTruncated.length() > 10)
		base64EncodedPublicKeyTruncated = base64EncodedPublicKeyTruncated.substring(0, 10);
  
		Log.i(TAG, "base64EncodedPublicKey " + base64EncodedPublicKeyTruncated);
